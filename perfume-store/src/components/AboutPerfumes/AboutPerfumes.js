...
import AboutPerfumesCard from './AboutPerfumesCard';
  ...
  const AboutPerfumes = () => {
      ...
      const displayedCards = showAll ? cardData : cardData.slice(0, 4);

      return (
          <div className="about-us">
            <h2><span className="underline-light_blue">A quick glance on our bestsellers</span></h2>
